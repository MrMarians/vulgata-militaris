...
The site is being built book by book, beginning with the **Liber Numerorum** ([[Liber Numerorum/01|Nm 1]]). Cards marked `draft` carry provisional occurrence counts; citations are progressively collated against the reference edition of the Vulgate (Weber–Gryson). Where the working text and the reference edition diverge, the divergence is noted rather than silently harmonised.

## Editions and further reading

Texts cited follow **Biblia Hebraica Stuttgartensia** (Hebrew), **Rahlfs–Hanhart** (Septuagint), **Field** (Hexapla fragments), **Sabatier** (Vetus Latina), and **Weber–Gryson, Biblia Sacra Vulgata**, 5th ed., Stuttgart 2007 (reference edition).

On Jerome's Numbers in particular:

- M. Kraus, «Rabbinic Traditions in Jerome's Translation of the Book of Numbers», *Journal of Biblical Literature* 136/3 (2017), 539–563.
- M. Settembrini – V. Anselmo, *Numeri 10,11–36,13. Nuova versione, introduzione e commento* (I Libri Biblici – Primo Testamento 4.2), Paoline, Milano 2026.
